...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MauiFirstUartApp.dll" comes first in this list. */
		"MauiFirstUartApp.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"UsbSerialForAndroid.Net.resources.dll",
		"MauiFirstUartApp.Core.dll",
